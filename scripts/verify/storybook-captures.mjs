...
const CAPTURES = [
  ...
  ['39-targets-entry', 'Product compositions/Targets/Entry sheet', 'Set daily goal — two routes, the reassurance note', 390, 100],
  ['39b-targets-about', 'Product compositions/Targets/Estimate steps', 'About you — 1/3, metric', 390, 100, 852],
  ['39c-targets-about-imperial', 'Product compositions/Targets/Estimate steps', 'About you — ft + in and lb, converted from the typed values', 390, 100, 852],
  ['39d-targets-about-errors', 'Product compositions/Targets/Estimate steps', 'About you — validation near the fields, focus on the first', 390, 100, 852],
  ['39e-targets-activity', 'Product compositions/Targets/Estimate steps', 'Your activity — 2/3, one selection card chosen', 390, 100, 852],
  ['39f-targets-goal-unsupported', 'Product compositions/Targets/Estimate steps', 'Your goal — a loss target under the floor is explained at selection', 390, 100, 852],
  ['39g-targets-help', 'Product compositions/Targets/Estimate steps', 'Help — a short explanation with Calculation details, focus returned', 390, 100, 852],
  ['39h-targets-review', 'Product compositions/Targets/Target editor', 'Review — the estimate as the result (1,699 kcal/day)', 390, 100, 852],
  ['39i-targets-review-adjusted', 'Product compositions/Targets/Target editor', 'Review — an adjusted value (1,650) stays labelled', 390, 100, 852],
  ['39j-targets-manual', 'Product compositions/Targets/Target editor', 'Manual — new targets entered by hand', 390, 100, 852],
  ['39k-targets-edit-estimated', 'Product compositions/Targets/Target editor', 'Edit — a saved estimate: source row, Recalculate, Remove targets', 390, 100, 852],
  ['39l-targets-scheduled', 'Product compositions/Targets/Target editor', 'Edit — a scheduled change stated once, with Cancel scheduled change', 390, 100, 852],
  ['39m-targets-remove-confirm', 'Product compositions/Targets/Target editor', 'Remove daily targets — confirmation names the scheduled change too', 390, 100, 852],
  ['39n-targets-save-error', 'Product compositions/Targets/Target editor', 'Save failed — the draft stays, Try again', 390, 100, 852],
  ['39o-targets-about-320-200', 'Product compositions/Targets/Estimate steps', 'About you — 320 at 200 %', 320, 200, 852],
  ['39p-targets-review-320-200', 'Product compositions/Targets/Target editor', 'Review — 320 at 200 %', 320, 200, 852],
  ['39q-targets-review-430', 'Product compositions/Targets/Target editor', 'Review — the estimate as the result (1,699 kcal/day)', 430, 100, 932],
  ['39r-selection-card-tiles', 'Components/SelectionCard', 'Tiles — an equal-width pair with centred labels', 390, 100],
  ['39s-focused-bar', 'Patterns/FocusedBar', 'Step 1/3 — centred between equal slots', 390, 100],
