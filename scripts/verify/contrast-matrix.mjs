...
const PAIRS = [
  ...
  ['Text on action (primary button)', 'text.on-action', 'action.primary', 4.5, 'primary button label, selected segment label'],
  ...
  ['Inactive navigation glyph on the group surface', 'navigation.content', 'navigation.surface', 3, 'regular 24 px glyph, icon-only destination'],
  ['Active navigation label on the selected surface', 'navigation.selected-content', 'navigation.selected-surface', 4.5, 'nav-label-active 10/14 700 and the bold glyph'],
  ['Log food glyph on the action', 'navigation.action-content', 'navigation.action-surface', 3, 'bold 24 px Plus glyph in the 56 px circle'],
